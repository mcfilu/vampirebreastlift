...
import {  oshot, pshot, clinic2} from '../assets';
...
//                 <button className={`p-[1vh] pl-[2vh] pr-[2vh] absolute -bottom-[2.2vh] bg-black text-gold1 text-[2vh] bg-opacity left-1/2  transform -translate-x-1/2 rounded-[2px] hover:bg-gold1 hover:text-black`}>READ MORE</button>
//             </div>
...
//     </div>
        ...
        <div  className={`flex flex-col md:flex-row w-full justify-between mt-[2vh] md:min-h-[70vh] `}>
            ...
            <div onMouseEnter={() => setHove1((prev) => !prev)} onMouseLeave={() => setHove1((prev) => !prev)} className={`relative flex flex-col  bg-gold1  w-[100%] md:w-[30%]  shadow-[0px_0px_50px_2px_#744210] hover:ease-in-out duration-500`}>
            <a href="https://www.oshot.uk">
                <div className={`relative flex w-full h-[40vh] overflow-hidden`}>
                    <img className={`flex w-full h-full  ease-in-out duration-500 object-cover ${hov1 ? 'scale-125' : ''}`} src={oshot}></img>
                    <div className={`absolute w-full top-[10vh] left-[2vw] `}>
                        <h1 className={`text-gold1 text-[5.5vh] text-left font-header`}>The O-shot</h1>
            ...
            <div onMouseEnter={() => setHove2((prev) => !prev)} onMouseLeave={() => setHove2((prev) => !prev)} className={`relative flex flex-col  bg-gold1 mt-[10vh] md:mt-[0px] w-[100%] md:w-[30%]  shadow-[0px_0px_50px_2px_#744210] hover:ease-in-out duration-500`}>
            <a href="https://www.pshot.co.uk">
            <div className={`relative flex w-full h-[40vh] overflow-hidden`}>
                    <img className={`flex w-full h-full  ease-in-out duration-500 object-cover ${hov2 ? 'scale-125' : ''}`} src={pshot}></img>
                    <div className={`absolute w-full top-[10vh] left-[2vw] `}>
...
penis to stimulate a regenerative process.</p>
            ...
            <div className={`relative flex w-full h-[40vh] bg-gray-500 overflow-hidden`}>
