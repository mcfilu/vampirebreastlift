...
const AugmentationServices = () => {
  ...
  return (
    ...
    //             <NavLink to={`/breast-reduction`}><button className={`p-[1vh] pl-[2vh] pr-[2vh] absolute -bottom-[2.2vh] bg-black text-gold1 text-[2vh] bg-opacity left-1/2  transform -translate-x-1/2 rounded-[2px] hover:bg-gold1 hover:text-black`}>READ MORE</button></NavLink>
    //         </div>
    ...
    //     <div  className={`relative flex flex-col  bg-gold1  w-[100%] md:w-[30%]  hover:bg-opacity-80 hover:shadow-[0px_0px_50px_2px_#744210] hover:ease-in-out duration-500`}>
    ...
    //     <div  className={`relative flex flex-col  bg-gold1 mt-[10vh] md:mt-[0px] w-[100%] md:w-[30%]  hover:bg-opacity-80 hover:shadow-[0px_0px_50px_2px_#744210] hover:ease-in-out duration-500`}>
    //     <div className={`relative flex w-full h-[40vh]`}>
    ...
    //         </div>
    //         <div className={`relative flex flex-col w-full  pt-[2vh] pb-[2.5vh] px-[1vh] md:px-[2vh]`}>
    //             <p className={`flex text-black text-[2.1vh] text-justify`}>Breast enlargement with fat, is a sophisticated cosmetic procedure that offers an alternative to traditional breast augmentation using implants. This innovative technique involves harvesting excess fat from other areas of the body and redistributing it to the breast area to enhance size, shape, and contour.</p>
    ...
    //     <div  className={`relative flex flex-col  bg-gold1   w-[100%] md:w-[30%] mt-[10vh] md:mt-[0px] hover:bg-opacity-80 hover:shadow-[0px_0px_50px_2px_#744210] hover:ease-in-out duration-500`}>
    //     <div className={`relative flex w-full h-[40vh]`}>
    ...
    //             <p className={`flex text-black text-[2.1vh] text-justify`}>Breast reduction, or mammoplasty, is a surgical procedure that reduces the size of the female breast. It provides relief for individuals with physical discomfort and emotional challenges caused by large and heavy breasts, improving their overall well-being of those seeking relief.</p>
