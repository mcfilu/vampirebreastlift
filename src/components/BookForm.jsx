...
const BookForm = () => {
  return (
    <div className={`flex flex-col md:flex-row w-full  mt-[10vh] ]`}>
        ...
        <p className="text-white font-main text-[2.5vh] mt-[5vh]"><a className={`hover:text-gold1 flex items-center`} href='mailto:info@vampirebreastlift.co.uk'><i className="fas fa-envelope mr-4 text-gold1 text-[5vh]"></i>Info@vampirebreastlift.co.uk</a></p>
