...
import { BloodCells, fat_cells, sherif } from '../assets';
  ...
  return (
    ...
    <div className={` flex w-full flex-row     `}>
        ...
        <div className={`hidden md:flex w-[45%] h-[100%] flex items-center`}>
            <video src={fat_cells} autoPlay loop muted className={` object-cover w-[100%] h-[100%]`}></video>
            {/* <img className={`w-full h-full object-cover`} src={sherif}></img> */}
        </div>

        <div className={`flex flex-col md:hidden`}>
            <p className={`flex text-gold1 text-[6vh] text-center`}>How does it work?</p>
            <video src={fat_cells} autoPlay loop muted className={` object-cover h-[100%]`}></video>
