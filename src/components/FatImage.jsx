...
const FatImage = () => {
  return (
    ...
    {/* <div className={`flex flex-col justify-center items-left h-screen w-[35%] ml-[3vh]`}> */}
                ...
                <h1 className={`text-gold1 text-[7vh] md:text-[8vh] font-header  mt-[3vh] text-left`}>Breast Fat</h1>
            <h1 className={`text-gold1 text-[7vh] md:text-[8vh] font-header md:mb-[3vh] text-left`}>Enlargement </h1>
