  ...
  return (
    <div className={`flex w-11/12 flex-row bg-black bg-opacity-20 ml-[4%] mr-[4%] h-[55vh] rounded-[9px] p-[2vh] hover:bg-opacity-30 hover:shadow-[0px_0px_50px_10px_#744210] hover:ease-in-out duration-500`}>
        <div className={`flex flex-col w-1/2 p-[3vh] bg-black bg-opacity-70 rounded-[9px] mr-[0.8vw]`}>
            ...
            <p className={`text-white font-poppins text-[1.4vh] text-justify mt-[3.5vh] mb-[2.5vh]`}>Harnessing the body’s natural healing and rejuvenation powers by harvesting platelet rich plasma (PRP) packed with growth factors (cells that are responsible for the body’s ability to repair/rejuvenate itself) from a small sample of the client’s own blood (hence the name ‘Vampire’ treatments) the Vampire Breast Lift can be implemented to:</p>
            <ul className={`text-white text-[1.3vh] font-poppins `}>
