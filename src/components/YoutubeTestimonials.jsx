  ...
  return (
    ...
    <div className={`flex flex-col sm:flex-row justify-center sm:justify-between mt-16 gap-x-4 sm:gap-x-0`}>
      ...
      <div className=" w-[95%] mx-auto my-auto ">
        ...
        <Slider {...settings}>
          <div className={`md:min-h-[65vh] p-6 px-[2vw]`}>
            <div className={`flex flex-col w-full h-full items-center justify-center bg-black bg-opacity-80  p-[2vh]`}>
              <div className={`flex h-[40%] w-[100%]`}>
                <iframe className="w-[100%] h-[20vh] xl:h-[28vh]" src="https://www.youtube.com/embed/Fph7J8NK4so?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              </div>
          ...
          <div className={`md:min-h-[65vh] p-6 px-[2vw]`}>
            <div className={`flex flex-col w-full h-full items-center justify-center bg-black bg-opacity-80  p-[2vh]`}>
              <div className={`flex h-[40%] w-[100%]`}>
                <iframe className="w-[100%] h-[20vh] xl:h-[28vh]" src="https://www.youtube.com/embed/TmsESS0zn74?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              </div>
            
              <div className={`flex flex-col items-center w-[100%] h-[48%] mt-[2vh]`}>
                <i className={`fa-solid fa-quote-right mr-[0.9vw] text-gold1 text-[1.3vw]`}></i>
                <p className={`text-white text-center text-[1.9vh]`}>In the past I had breast implants, but after breastfeeding they didnt look good. I researched some other options and came across Dr. Wakil. I didnt feel any pain at all and was able to just walk away from the treatment as normal. Im really please with the results, especially with the lift and the shape. Thats excatly what I wanted.</p>
          ...
          <div className={`md:min-h-[65vh] p-6 px-[2vw]`}>
            <div className={`flex flex-col w-full h-full items-center justify-center bg-black bg-opacity-80  p-[2vh]`}>
              <div className={`flex h-[40%] w-[100%]`}>
                <iframe className="w-[100%] h-[20vh] xl:h-[28vh]" src="https://www.youtube.com/embed/M0GiG9xyxJo?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              </div>
            
              <div className={`flex flex-col items-center w-[100%] h-[48%] mt-[2vh]`}>
                <i className={`fa-solid fa-quote-right mr-[0.9vw] text-gold1 text-[1.3vw]`}></i>
                <p className={`text-white text-center text-[1.9vh]`}>Several years ago I had breast surgery which left me with some nerve damage on one side. Dr. Sherif introduced to me Vampire BreastLift, I tolerated it very well, it was not painfull at all. After 2 months from the precudeure I started to get the sensation back again and now its complemetely back. Its just been amazinng and Im so thankfull to Dr. Sherif. </p>
          ...
          <div className={`md:min-h-[65vh] p-6 px-[2vw]`}>
            <div className={`flex flex-col w-full h-full items-center justify-center bg-black bg-opacity-80  p-[2vh]`}>
              <div className={`flex h-[40%] w-[100%]`}>
              <iframe className="w-[100%] h-[20vh] xl:h-[28vh]" src="https://www.youtube.com/embed/EbBj4Hitfyo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              </div>
            
              <div className={`flex flex-col items-center w-[100%] h-[48%] mt-[2vh]`}>
                <i className={`fa-solid fa-quote-right mr-[0.9vw] text-gold1 text-[1.3vw]`}></i>
                <p className={`text-white text-center text-[1.9vh]`}>I always wanted to do something with my breast but didnt want to go down the road with plastic surgery I'm acutally thrilled that this gives me the results I wanted. This is non-invasive and it's something that gives me the natural results I wanted so much.</p>
                <h1 className={`text-gold1 text-[3vh] text-center mt-[2vh]`}>HIMA</h1>
                <h3 className={`text-white text-[1.9vh] text-center`}>39 Years Old, UK</h3>
              </div>
            </div>
          </div>
