...
const HomeSlider = () => {
  return (
    <Carousel showArrows={false} showStatus={false} showThumbs={false} interval={4000} autoPlay={true} infiniteLoop={true} transitionTime={1000} swipeable={false} animationHandler={"fade"}>
