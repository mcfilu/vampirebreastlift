...
const FatFaqs = () => {
    ...
    return (
        ...
        //         <h1 className={`text-gold1 font-main text-center text-[4vh] mb-[1vh]`}>Frequently Asked Questions</h1>
        ...
        //                 <h1 className={`${openFirst ? 'text-gold1' : 'text-white'} font-main text-[2.4vh]`}>How does the Breast Enlargement with Fat work?</h1>
        //             </div>
        //             <div className={`flex flex-col ${openFirst ? '' : 'hidden'} w-[35vw] my-[1vh] ml-[5%]`}>
        //                 <p className={`text-white text-[1.7vh] text-justify font-main`}>
        ...
        //                 </p>
        //                 <p className={`text-white text-[1.7vh] text-justify font-main mt-[1.5vh]`}>
        ...
        //                 <h1 className={`${openSecond ? 'text-gold1' : 'text-white'} font-main text-[2.4vh]`}>Am i suitable for this treatment?</h1>
        //             </div>
        ...
        //                 <h1 className={`${openThird ? 'text-gold1' : 'text-white'} font-main text-[2.4vh]`}>Does it hurt?</h1>
        //             </div>
        ...
        //                 <h1 className={`${openFourth ? 'text-gold1' : 'text-white'} font-main text-[2.4vh]`}>How long does it take?</h1>
        //             </div>
        ...
        //                 <h1 className={`${openFifth ? 'text-gold1' : 'text-white'} font-main text-[2.4vh]`}>Is there any downtime/recovery time?</h1>
        //             </div>
        ...
        //                 <h1 className={`${openSixth ? 'text-gold1' : 'text-white'} font-main text-[2.4vh]`}>What kind of results can I expect?</h1>
        //             </div>
