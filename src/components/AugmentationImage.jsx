...
import {  augmentation2 } from '../assets'
...
const AugmentationImage = () => {
  return (
    ...
    //                 <h1 className={`text-gold1 text-[5vh] font-poppins mb-[3vh] mt-20 text-left`}>Breast Augmentation</h1>
    //                     <h1 className={`text-white text-[2.5vh] font-poppins mb-[3vh] text-justify`}>Enhance your natural beauty and embrace your desired silhouette with Breast Augmentation - the transformative procedure that helps you achieve the breast shape, size, and firmness you've always desired. Experience the artistry of breast augmentation and rediscover a more confident you.</h1>
