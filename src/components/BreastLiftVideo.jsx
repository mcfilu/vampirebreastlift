...
const BreastLiftVideo = () => {
  return (
    <div className={`bg- flex flex-col items-center justify-center w-full md:p-[2vh] md:pl-0`}>
        <div className={`hidden md:flex`}>
          <div className={`flex flex-row justify-between w-full h-full mt-[2vh]`}>

              <div className={`flex items-center justify-end w-[45%] h-full  overflow-hidden`}> 
