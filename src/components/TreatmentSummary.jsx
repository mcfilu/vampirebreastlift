...
function TreatmentSummary() {
  return (
    <div>
    <section>
        <div className={`relative bg-black bg-opacity-70 p-[3vh] flex flex-col w-3/5 mx-auto rounded-[9px]`}>
            ...
            <div className={`absolute bg-gold1 top-1/3 -right-56 w-[22vw] h-[45vh] rounded-[9px] p-[3vh]`}>
                    <h1 className={`font-poppins text-[30px]`}>Treatment Cost</h1>
                    <p className={`font-poppins text-[12px] mt-[2vh]`}>Price from:</p>
                    <h1 className={`font-poppins text-[60px] mt-[2vh]`}>£ 1200</h1>
                    <p>* After consultation the doctor will confirm the cost.</p>
                    <p className="mt-[2vh] mb-2 h-[40px] w-[150px] bg-black text-white bg-opacity-60 rounded-[9px] flex items-center justify-center hover:text-gold1 hover:bg-white"><PopupButton
