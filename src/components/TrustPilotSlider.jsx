...
const TrustPilotSlider = () => {
    const items = [
        ...
        <div className={`flex flex-col w-full items-start mt-[3vh]`}>
            ...
            <p className={`text-white text-[1.8vh] text-left mt-[2vh]`}>This was my fourth visit to Dr Wakil and he never fails to amaze me! I would give 7 stars if I could! Staff are friendly and extremely professional and they fit me in really last minute as well! Dr Wakil is fantastic. I have complete confidence in his abilities, always delighted with my results. I wouldn’t hesitate recommending him to family and friends.</p>
