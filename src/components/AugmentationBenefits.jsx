...
import { augmentation_vid, boobs7 } from '../assets'
...
<div className={`hidden md:flex flex flex-col w-[55%] p-[2vh]   `}>
    <h1 className={`text-gold1 text-[5vh] text-center font-poppins`}>Breast Augmentation Benefits</h1>
    <p className={`text-white font-poppins text-[2.1vh] text-justify mt-[3vh] mb-[2vh]`}>The primary objective of a breast augmentation procedure is to enhance the size and shape of the breasts, creating a more balanced, symmetrical figure. Based on feedback from patients, the benefits of this surgery can include:</p>
...
<h1 className={`text-gold1 text-[5vh] text-center font-poppins`}>Breast Augmentation Benefits</h1>
<video src={boobs7} autoPlay loop muted className={` object-cover h-[100%] w-[100%]`}></video>
<p className={`text-white font-poppins text-[2.1vh] text-left pl-[1vh] mt-[3vh] mb-[2vh]`}>The primary objective of a breast augmentation procedure is to enhance the size and shape of the breasts, creating a more balanced, symmetrical figure. Based on feedback from patients, the benefits of this surgery can include:</p>
