...
import { boobs1, breast_augmentation2, breast_reduction2 } from '../assets';
...
const FatServices = () => {
  ...
  return (
    ...
    <div className={`flex flex-col md:flex-row w-full justify-between mt-[2vh] md:min-h-[65vh] `}>
        ...
        <NavLink to={`/`}>
        <div className={`relative flex w-full h-[40vh] overflow-hidden `}>
                <img className={`flex w-full h-full  ease-in-out duration-500 object-cover hover:scale-125 ${hov2 ? 'scale-125' : ''}`} src={boobs1}></img>
                <div className={`absolute w-full top-[10vh] left-[2vw] `}>
