...
const FatBenefits = () => {
  return (
    ...
    //         <h1 className={`text-gold1 text-[4vh] text-center font-main`}>Breast Fat Enlargement Benefits</h1>
    //         <p className={`text-white font-main text-[1.7vh] text-justify mt-[2.5vh] mb-[1vh]`}>The goal of Breast Enlargement with Fat is to enhance the size and shape of the breasts using the patient's own fat. It promotes a natural-looking enlargement while also refining the overall silhouette of the body. According to client reports, benefits of the procedure include:</p>
    ...
    //             <li className={`flex items-center mt-[1vh]`}><i class="" className={`text-gold1 mr-4 fa-solid fa-circle text-[1.6vh]`}></i>Smoother skin texture over the breast area</li>
