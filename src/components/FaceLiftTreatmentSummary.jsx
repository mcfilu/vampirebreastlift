...
const FaceLiftTreatmentSummary = () => {
    const [hov, setHove] = useState(false);
  return (
    <div onMouseEnter={() => setHove(true)} onMouseLeave={() => {setHove(false)}} className={`relative ml-[13vw] bg-black bg-opacity-70 p-[3vh] flex flex-col w-[55%] min-h-[68vh]  rounded-[9px] pr-[14vh] hover:bg-opacity-80 hover:shadow-[0px_0px_50px_10px_#744210] hover:ease-in-out duration-500`}>
            <div className={` w-[100%] mx-auto h-[100%]`}>
                ...
                <div>
                    ...
                    <div className={`flex flex-row`}>
                        ...
                        <p className="text-[1.7vh] font-light text-white">Minor discomfort, pink marks at injection sites.</p>
                    </div>

                    <hr className={`mt-[2vh] mb-4`}></hr>
                    <div className={`flex flex-row`}>
                        <span className="text-[1.7vh] font-medium w-[30%] text-gold1 flex items-center">Results:</span>
                        <p className="text-[1.7vh] font-light text-white w-[70%]">Facial ageing naturally improved, complexion rejuvenated and face re-volumized.
                        </p>
                    </div>
                    ...
                    <div className={`flex flex-row`}>
                        ...
                        12-24 months with good skincare regime.
                        </p>
                    </div>
                    <hr className={`mt-[2vh] mb-4`}></hr>
                    <div className={`flex flex-row`}>
            ...
            <div onMouseEnter={() => setHove(true)}  className={`absolute bg-gold1  ease-in-out duration-500 ${hov ? 'bg-opacity-100' : 'bg-opacity-90'} top-[22%] -right-[14.5vw] w-[19vw] h-[38vh] rounded-[9px] p-[2vh] `}>
                    ...
                    <h1 className={`font-poppins font-bold text-[5vh] `}>£ 600</h1>
...
export default FaceLiftTreatmentSummary