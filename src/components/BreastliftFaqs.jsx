    ...
    return (
        <section className={` w-full`}>
            <div className={` p-[2vh]   `}>
                ...
                <hr className={`border-gold1 mt-[1vh] mb-[1.2vh] w-[75%] mx-auto`}></hr>
                <div className={`flex flex-col ml-[5%]`} onClick={() => {setFirst(!openFirst)}}>
                    <div className={`flex flex-row justify-left`}>
                        ...
                        <h1 className={`${openFirst ? 'text-black' : 'text-black'} font-poppins text-[2.8vh]`}>How does the Vampire BreastLift work?</h1>
                    </div>
                    <div className={`flex ${openFirst ? '' : 'hidden'} w-[35vw] my-[1vh] ml-[5%]`}>
                        <p className={`text-black text-[2.1vh] text-justify font-poppins`}>
                ...
                <hr className={`border-gold1 mt-[1.4vh] mb-[1.4vh] w-[75%] mx-auto`}></hr>
                <div className={`flex flex-col ml-[5%]`} onClick={() => {setSecond(!openSecond)}}>
                    <div className={`flex flex-row justify-left`}>
                        ...
                        <h1 className={`${openSecond ? 'text-black' : 'text-black'} font-poppins text-[2.8vh]`}>Am i suitable for this treatment?</h1>
                    </div>
                ...
                <div className={`flex flex-col ml-[5%]`} onClick={() => {setThird(!openThird)}}>
                    <div className={`flex flex-row justify-left`}>
                        ...
                        <h1 className={`${openThird ? 'text-black' : 'text-black'} font-poppins text-[2.8vh]`}>Does it hurt?</h1>
                    </div>
                ...
                <div className={`flex flex-col ml-[5%]`} onClick={() => {setFourth(!openFourth)}}>
                    <div className={`flex flex-row justify-left`}>
                        ...
                        <h1 className={`${openFourth ? 'text-black' : 'text-black'} font-poppins text-[2.8vh]`}>How long does it take?</h1>
                    </div>
                ...
                <div className={`flex flex-col ml-[5%]`} onClick={() => {setFifth(!openFifth)}}>
                    <div className={`flex flex-row justify-left`}>
                        ...
                        <h1 className={`${openFifth ? 'text-black' : 'text-black'} font-poppins text-[2.8vh]`}>Is there any downtime/recovery time?</h1>
                    </div>
                ...
                <div className={`flex flex-col ml-[5%]`} onClick={() => {setSixth(!openSixth)}}>
                    <div className={`flex flex-row justify-left`}>
                        ...
                        <h1 className={`${openSixth ? 'text-black' : 'text-black'} font-poppins text-[2.8vh]`}>What kind of results can I expect?</h1>
                    </div>
                    <div className={`flex ${openSixth ? '' : 'hidden'} flex-col w-[35vw] my-[1vh] ml-[5%]`}>
                        ...
                        <ul className={`text-black text-[2.1vh] font-poppins my-[1vh] mb-6`}>
                        ...
                        <p className={`text-black text-[2.1vh] font-poppins`}>Like other Vampire Procedures, the Vampire Breast Lift™ injections will last about 12-24 months, depending on individual patients.</p>
                    </div>
                </div>
                <hr className={`border-gold1 mt-[1.4vh] mb-[1.4vh] w-[75%] mx-auto`}></hr>
            </div>
