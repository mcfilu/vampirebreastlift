...
const OtherServices = () => {
  return (
    <div className={`flex flex-col bg-opacity-70 w-full pl-[4%] pr-[4%]`}>
        ...
        <div className={` pr-[3vh]`}>
            {/* <h1 className={`text-gold1 text-[4vh] font-poppins`}>Other Treatmens</h1> */}
            {/* <p className={`text-white text-[15px] font-poppins mt-[3vh]`}>Dr Sherif Wakil is regularly interviewed by the mainstream press as an expert in the subject of sexual health and well-being.</p> */}
        </div>
        ...
        <div className={`flex flex-row w-full h-[75vh] justify-between`}>
            ...
            <div className={`relative flex flex-col h-full bg-black bg-opacity-70 w-[31%] rounded-[9px]`}>
                <div className={`flex w-full h-[55%] p-[1vh]`}>
                ...
                <div className={`flex flex-col w-full h-1/4 p-[1vh] pt-2`}>
            ...
            <div className={`relative flex flex-col bg-black bg-opacity-70 w-[31%] rounded-[9px]`}>
                ...
                <div className={`flex flex-col w-full h-1/4 p-[1vh] pt-2`}>
                    <p className={`text-white text-[1.7vh] text-justify `}>The P-Shot® procedure works by using the body’s natural ability to heal and rejuvenate itself by injecting growth factor rich Platelet Rich Plasma (PRP) into the penis to stimulate a regenerative process.</p>
                </div>
                <button className={`p-[1vh] pl-[2vh] pr-[2vh] absolute -bottom-[2.2vh] bg-black text-gold1 text-[2vh] bg-opacity left-1/2  transform -translate-x-1/2 rounded-[10px] hover:bg-gold1 hover:text-black`}>READ MORE</button>
            </div>
        ...
        <div className={`flex flex-row w-full h-[75vh] mt-24 justify-between`}>
            ...
            <div className={`relative flex flex-col bg-black bg-opacity-70 w-[31%] rounded-[9px]`}>
                ...
                <div className={`flex flex-col w-full h-1/4 p-[1vh] pt-2`}>
                    <p className={`text-white text-[1.7vh] text-justify`}>Developed by Dr Sherif Wakil, treatment uses a combination of avant-garde anti-ageing techniques that use the body’s own natural processes and tissue to rejuvenate skin and correct loss of volume. The Non-Surgical Face Lift is the ultimate in natural treatments and an exclusive Dr SW Skin Clinic procedure.</p>
                </div>
                <button className={`p-[1vh] pl-[2vh] pr-[2vh] absolute -bottom-[2.2vh] bg-black text-gold1 text-[2vh] bg-opacity left-1/2  transform -translate-x-1/2 rounded-[10px] hover:bg-gold1 hover:text-black`}>READ MORE</button>
            </div>
            ...
            <div className={`relative flex flex-col bg-black bg-opacity-70 w-[31%] rounded-[9px]`}>
                ...
                <div className={`flex flex-col w-full h-1/4 p-[1vh] pt-2`}>
                    <p className={`text-white text-[1.7vh] text-justify`}>Dr SW Clinics offer a number of non-surgical body treatments for fat reduction, including: The O.F.F system is a state of the art electro-medical device, which can be used for non-invasive micro-lipoplasty. This technology is new to the UK and Dr Wakil is one of the first doctors to offer treatments with it.</p>
                </div>
                <button className={`p-[1vh] pl-[2vh] pr-[2vh] absolute -bottom-[2.2vh] bg-black text-gold1 text-[2vh] bg-opacity left-1/2  transform -translate-x-1/2 rounded-[10px] hover:bg-gold1 hover:text-black`}>READ MORE</button>
            </div>
