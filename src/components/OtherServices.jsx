    ...
    <div className={`flex flex-col  w-full pl-[4%] pr-[4%]`}>
        ...
        <div className={`flex flex-row w-full h-[72vh] justify-between mt-[2vh]`}>
            ...
            <div onMouseEnter={() => setHove1(false)} onMouseLeave={() => {setHove1(false)}} className={`relative flex flex-col h-full bg-black   w-[31%]  hover:bg-opacity-80 hover:shadow-[0px_0px_50px_10px_#744210] hover:ease-in-out duration-500`}>
                ...
                <NavLink to={`/breast-augmentation`}><button className={`p-[1vh] pl-[2vh] pr-[2vh] absolute -bottom-[2.2vh] bg-gold1 text-white text-[2vh] bg-opacity left-1/2  transform -translate-x-1/2  hover:bg-gold1 hover:text-black`}>READ MORE</button></NavLink>
            </div>
            ...
            <img className={` w-full h-[55%] ${hov1 ? 'scale-110' : ''} ease-in-out duration-500`} src={breast_enlargement}></img>
                ...
                <NavLink to={`/breast-fat-enlargement`}><button className={`p-[1vh] pl-[2vh] pr-[2vh] absolute -bottom-[2.2vh] bg-gold1 text-white text-[2vh] bg-opacity left-1/2  transform -translate-x-1/2  hover:bg-gold1 hover:text-black`}>READ MORE</button></NavLink>
            </div>
            ...
            <img className={` w-full h-[55%] ${hov1 ? 'scale-110' : ''} ease-in-out duration-500`} src={breast_reduction}></img>
                ...
                <NavLink to={`/breast-reduction`}><button className={`p-[1vh] pl-[2vh] pr-[2vh] absolute -bottom-[2.2vh] bg-gold1 text-white text-[2vh] bg-opacity left-1/2  transform -translate-x-1/2  hover:bg-gold1 hover:text-black`}>READ MORE</button></NavLink>
            </div>
