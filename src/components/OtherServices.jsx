  ...
  return (
    <div className={`flex flex-col  w-full pl-[4%] pr-[4%]`}>
        ...
        <div className={`flex flex-col md:flex-row w-full md:h-[72vh] justify-between mt-[2vh]`}>
            ...
            <div onMouseEnter={() => setHove1(false)} onMouseLeave={() => {setHove1(false)}} className={`relative flex flex-col h-full bg-gold1  w-full md:w-[31%]  hover:bg-opacity-80 hover:shadow-[0px_0px_50px_10px_#744210] hover:ease-in-out duration-500`}>
            ...
            <div onMouseEnter={() => setHove2(true)} onMouseLeave={() => {setHove2(false)}} className={`relative flex flex-col h-full bg-gold1 mt-[10vh] md:mt-[0px]  w-full md:w-[31%]  hover:bg-opacity-80 hover:shadow-[0px_0px_50px_10px_#744210] hover:ease-in-out duration-500`}>
            ...
            <div onMouseEnter={() => setHove3(true)} onMouseLeave={() => {setHove3(false)}} className={`relative flex flex-col h-full bg-gold1 mt-[10vh] md:mt-[0px]  w-full md:w-[31%]  hover:bg-opacity-80 hover:shadow-[0px_0px_50px_10px_#744210] hover:ease-in-out duration-500`}>
