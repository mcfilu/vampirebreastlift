          ...
          <div className={`flex flex-row justify-between w-full h-full mt-[2vh]`}>
              ...
              <div className={`flex flex-col justify-center items-center w-[55%] h-full md:p-[2vh]`}>
                <p className={`text-gold1 text-[5vh] text-center font-header`}>Breast Augmentation Explained</p>
                  ...
                  <NavLink to={`/book-now`}><button className={` text-[3vh] px-[2vh] py-[0.5vh] bg-black border-gold1 border-2 text-gold1 hover:bg-white mt-[5vh] md:mt-[0px] font-main`}>Book Consultation</button></NavLink>
              </div>
