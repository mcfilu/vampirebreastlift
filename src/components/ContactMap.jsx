        ...
        <div className={`hidden md:flex relative  w-[45%] flex flex-col  `}>
            <div className={`h-full flex flex-col justify-center items-center `}>
              ...
              <div className={`flex flex-col `}>
                ...
                <NavLink to={`/book-now`}><button className={`bg-black border-2 border-gold1 text-gold1 hover:bg-white font-main text-[3vh] p-[1vh] mt-[5vh]`}>Book Consultation</button></NavLink>
