...
const ContactMap = () => {
  ...
  return (
    <div className={`h-[70vh] w-full flex flex-row justify-between mb-12`}>
        ...
        <div className={`relative bg-black bg-opacity-70 w-[50%] flex flex-col rounded-[9px]  mr-[4%]`}>
            <div className={`h-full flex flex-col justify-center items-center `}>
              <h1 className={`text-gold1 text-[50px] font-poppins pb-4`}>Contact Us</h1>
              <div className={`flex flex-col `}>
                <div className={`mt-4`}>
                  ...
                  <p className="mb-2 text-white font-poppins text-[20px] mt-4"><a className={`hover:text-gold1 flex items-center`} href="tel:+44 (0)20 7467 5340"><i className="fas fa-phone mr-4 text-gold1 text-[30px]"></i>+44 (0)20 7467 5340</a></p>
                  <p className="mb-2 text-white font-poppins text-[20px] mt-4"><a className={`hover:text-gold1 flex items-center`} href="tel:+44 (0)20 7467 5340"><i className="fas fa-phone mr-4 text-gold1 text-[30px]"></i>+44 (0)20 3006 8459</a></p>
                  
                </div>
                <div className={`flex flex-row mt-4`}>                
                  <div className={`flex items-center`}>
                      <i className="fas fa-map-marker-alt text-gold1 text-[50px] mr-6"></i>
                  </div>
                  <div>
