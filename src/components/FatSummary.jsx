...
function FatSummary() {
  ...
  return (
    ...
    //     </div>
    <div onMouseEnter={() => setHove(true)} onMouseLeave={() => {setHove(false)}} className={`relative md:ml-[13vw] bg-black bg-opacity-100 p-[3vh] md:my-[5vh] flex flex-col md:w-[60%] h-auto min-h-[68vh]  md:pr-[14vh] hover:bg-opacity-100 md:shadow-[0px_0px_20px_1px_#ad9444] hover:ease-in-out duration-500`}>
            <div className={` w-[100%] mx-auto h-[100%]`}>
            ...
            <div onMouseEnter={() => setHove(true)}  className={`md:absolute bg-gold1  bg-opacity-100  shadow-[0px_0px_20px_2px_#ad9444] ease-in-out duration-500 ${hov ? 'bg-opacity-100' : 'bg-opacity-100'} top-[22%] -right-[17.5vw] md:w-[24vw]   p-[2vh] mt-[5vh] md:mt-[0px]`}>
                    ...
                    <NavLink to={`/book-now`}><button className={`bg-black text-gold1 text-[4vh] md:text-[2.5vh] mt-[4vh] p-[1vh]`}>Book Now</button></NavLink>
                </div>
